...
const createUserToken = (user) => {
    ...
    const accessToken = (0, jwt_1.generateToken)(jwtPayload, env_1.envVar.JWT_ACCESS_SECRET, env_1.envVar.JWT_ACCESS_EXPIRES);
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const veryfyRefreshToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVar.JWT_REFRESH_SECRET);
    const isUserExist = yield user_model_1.User.findOne({ email: veryfyRefreshToken.email });
    if (!isUserExist) {
