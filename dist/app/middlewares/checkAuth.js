...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.headers.authorization) {
            accessTokenRecieved = req.headers.authorization;
        }
        else if (req.cookies && req.cookies.accessToken) {
            accessTokenRecieved = req.cookies.accessToken;
        }
        // const accessTokenRecieved = req.headers.authorization;
        if (!accessTokenRecieved) {
            throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "accessToken is not access !*!");
        }
        const verifiedToken = (0, jwt_1.verifyToken)(accessTokenRecieved, env_1.envVar.JWT_ACCESS_SECRET);
        ...
        if (!authRoles.includes(verifiedToken.role)) {
            throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "This Role is not permitated !*!");
        }
